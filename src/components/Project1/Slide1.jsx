...
const Slide1 = () => {
    return (
        <div className="w-full flex pl-64 lg:pl-20 pr-40 pt-24 lg:pt-16 xlMid:pt-24 xlMid:pl-28 2xl:pl-28 4xl:pl-36 flex-row justify-start">
            <img src={p1_1} className="h-[73vh] w-[31vw] lg:h-[73vh] lg:w-[40vw] lgMid:w-[37vw] lgMid:h-[73vh] xlMid:w-[38vw] 2xl:w-[35vw] 4xl:h-[75vh]" alt="" />
            <div className={`w-[39%] ml-28 lg:ml-12 lgMid:ml-16 xl:ml-24 flex flex-col items-start`}>
                ...
                <div className="lg:mt-6 font-gilroy h-full flex flex-col items-start justify-around">
                    <p className="text-[28px] lg:text-[99%] lg:leading-[175%] lgMid:text-[114%] lgMid:leading-[190%] xl:text-[130%] xl:leading-[190%] xlMid:text-[140%] xlMid:leading-[190%] 2xl:text-[150%] 2xl:leading-10 3xl:text-[175%] 3xl:leading-relaxed 4xl:text-[200%]"
                    ...
                    <p className="-mt-20 lg:-mt-4 lgMid:-mt-2 xl:mt-0 lg:text-[99%] leading-[175%] lgMid:text-[114%] lgMid:leading-[190%] xl:text-[130%] xl:leading-[190%] xlMid:text-[140%] 2xl:text-[150%] 2xl:leading-10 3xl:text-[175%] 3xl:leading-relaxed 4xl:text-[200%]">It struck me because I was just as <br/>uninformed, 
